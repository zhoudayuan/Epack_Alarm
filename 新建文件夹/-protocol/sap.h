...
typedef enum _CCL_DATA_TYPE_E
{
    ...
    CT_STUN_REQ_NAS         = 0x23,                      ///< 摇晕REQ
    CT_STUN_ACK_NAS         = 0x24,                      ///< 摇晕ACK
    CT_KILL_REQ_NAS         = 0x25,                      ///< 摇毙REQ
    CT_KILL_ACK_NAS         = 0x26,                      ///< 摇毙ACK
...
typedef struct _T_OverFlag {
    int ItemOver;
} T_OverFlag;

T_OverFlag *ptOverFlag;
